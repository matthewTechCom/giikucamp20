      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 iphone:w-full iphone:h-full">
        ...
        {currentStep === 2 && (
          <div className="bg-gray-800 text-slate-100 min-w-56 bg-opacity-90 px-11  py-72 rounded-md">
            ...
            <div className="bg-gray-500 bg-opacity-40 rounded-lg">
              <div className="">
                <p className="text-center text-xl p-3 font-bold">
                  ルームの作成
                </p>
                <div className="m-14">
                  <p>ルーム名</p>
                ...
                <div className="flex gap-5 items-center justify-center pb-4">
                  <button
                    className="bg-yellow-300 rounded-lg text-black p-2"
                    onClick={() => backStep()}
                  >
                    ← 戻る
                  </button>
        ...
        {currentStep === 3 && (
          <div className="">
            <button
              className="bg-yellow-300 rounded-lg text-black p-3"
              onClick={() => submitDatas()}
            >
              チャットを作りたい場所を選択してください
            </button>
          </div>
        )}
      </div>
